        ...
        <div className="divide-y">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="flex items-center p-4">
              ...
              <Skeleton className="h-4 w-32 mr-4" /> {/* Jenis Honor */}
              <Skeleton className="h-4 w-24 mr-4" /> {/* Honor Per Jam */}
              <Skeleton className="h-4 w-48 mr-4" /> {/* Keterangan */}
              <Skeleton className="h-4 w-28 mr-4" /> {/* Status */}
