          ...
          <CardContent className="pt-6 flex flex-col items-center">
            ...
            <div className="mt-6 space-y-3 w-full">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{data.phone || "No phone provided"}</span>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{data.laboratory || "Not assigned"}</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span>
                  {data.startPeriod
                    ? new Date(data.startPeriod).toLocaleDateString()
                    : "N/A"}{" "}
                  -
                  {data.endPeriod
                    ? new Date(data.endPeriod).toLocaleDateString()
                    : "Present"}
                </span>
              </div>
            </div>
